...
public class DaoManagerImpl extends AbstractDaoManager {
	...
	public OperationsDAO getOperationsDAO() {
		if(isTemplateMode()) {
			return new OperationsDAOImpl(getSession(), "OperationsMapper");
		} else {
			throw new IllegalStateException(ERROR_MSG);
		}
	}
	...
	/*
	@Override
	public UserFileRecoveryDao getUserFileRecoveryDao() {
		if(isTemplateMode()) {
			return new UserFileRecoveryDaoImpl(getSession(), "OrdersMapper");
		} else {
			throw new IllegalStateException(ERROR_MSG);
		}
	}
*/
	...
	public OrdersDao getOrdersDao() {
		if(isTemplateMode()) {
			return new OrdersDaoImpl(getSession(), "OrdersMapper");
		} else {
			throw new IllegalStateException(ERROR_MSG);
		}
	...
	@Override
	public UsersPrivilegesDao getUsersPrivilegesDao() {
		if(isTemplateMode()) {
			return new UsersPrivilegesDaoImp(getSession(), "UsersPrivilegesMapper");
		} else {
			throw new IllegalStateException(ERROR_MSG);
		}
	}
