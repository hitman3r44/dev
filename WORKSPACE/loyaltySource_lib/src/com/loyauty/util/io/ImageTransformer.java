...
public class ImageTransformer
{
    ...
    //created by mounir for crop image 
    public static void cropImage(String sourceFile, int x1, int y1,  int width, int height, String destinationFile)
    {
    	try{
    		
    		PlanarImage img = loadImage(sourceFile);
