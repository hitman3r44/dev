...
public final class BackEndConstants {
	...
	public static final int USER_VIEW_GROUP = 3;	
	public static final int USER_TRANSLATE_GROUP = 4;	
	...
	// Automatic Shipping Directory Constants
	public static final String SHIPPING_DIR = "/usr/apache-tomcat-7.0.27/webapps/shipping-calc/";
	// public static final String SHIPPING_DIR = "C:\\";	
	public static final String SHIPPING_SHELL_EXEC_PGM = "/root/scripts/autoShipping.sh";
	public static final double POUND_TO_KG_FACTOR = .45359237d;
	public static final double INCH_TO_CM_FACTOR = 2.54d;
	public static final double COVERAGE_RATE_PER_100$ = 1.80d;
