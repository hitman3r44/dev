...
public interface CommonService extends Service {
	...
	/** 
	 * Returns All the ProductStatuses.
	 * @return
	 * @throws ServiceException
	 */
	List<CommonDTO> getAllProductStatuses() throws ServiceException;

	List<CommonDTO> getUserProductStatusGroup() throws ServiceException;
