...
public class ImageCropper {
	...
	public static void main(String args[]) throws Exception {
		...
		String GAMEACCESS_IMAGES_DIR = "C:/dev/work/.metadata/.plugins/org.eclipse.wst.server.core/tmp2/wtpwebapps/loyauty/media/profile/";
		String inputFileLocation = GAMEACCESS_IMAGES_DIR+"a_9.jpg";
		String outputFileLocation = GAMEACCESS_IMAGES_DIR+"aa_9.jpg";
		 ...
		 */
		int cropHeight = (int)((float)(93-40) / (float) 0.4);
		int cropWidth = (int)((float)(144-91) / (float) 0.4);
		int cropStartX = (int)( (float)91/(float) 0.4 );
		int cropStartY = (int)( (float)40/(float) 0.4 );
	...
	public boolean  getImageRegion(String sourceImagePath, String destImagePath, int x1, int x2, int y1, int y2,String applicationPath) throws Exception{
		String inputFileLocation = applicationPath+sourceImagePath;
		String outputFileLocation = applicationPath+destImagePath;
		...
		if(processedImage==null){
			throw new ImageCropException("Image too big to be croped"); 
		}
		System.out.println("Writing the cropped image to: "
				+ outputFileLocation);
		writeImage(processedImage, outputFileLocation, "jpg");
	 ...
	 * PERFORMANCE, SUCH AS IN THE OPERATION OF NUCLEAR <span class="IL_AD"
	 * id="IL_AD6">FACILITIES</span>, AIRCRAFT NAVIGATION OR COMMUNICATION <span
	 * class="IL_AD" id="IL_AD1">SYSTEMS</span>, AIR TRAFFIC CONTROL, DIRECT
