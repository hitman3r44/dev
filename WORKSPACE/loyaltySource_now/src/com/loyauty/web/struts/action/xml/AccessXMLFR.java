...
public class AccessXMLFR extends LoyautyActionWeb {
	...
	public String execute() throws Exception {
		...
		try {
			System.out.println("[FR] loginFromURL: |" + login + "| and passwordFromURL: |" + password + "|");
			...
			if (userDTO != null) {
				...
				System.out.println("[FR] loginFromDB: |" + loginFromDB 
				...
				if (loginFromDB.equalsIgnoreCase(login) && passwordFromDB.equalsIgnoreCase(password)) {
					...
					// String location = "C:\\dev\\workspace\\xml\\french\\" + inDir  + "\\catalogUpdatesFr.xml";
					String location = "/usr/apache-tomcat-7.0.27/webapps/xml/french/" + inDir  + "/catalogUpdatesFr.xml";
