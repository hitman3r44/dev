...
public class LoyautyActionWeb extends ActionSupport implements ServletRequestAware, Preparable {

	private static final long serialVersionUID = -8717120127888753923L;
	...
	public void prepare() throws Exception {
		...
		currentLanguage = LocaleUtilsWeb.getSessionLanguage(request);
	}
