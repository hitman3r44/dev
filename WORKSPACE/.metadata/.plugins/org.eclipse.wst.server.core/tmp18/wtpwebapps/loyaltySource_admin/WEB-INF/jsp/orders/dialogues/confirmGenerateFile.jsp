...
<div id="confirmGenerateFile" class="conteneurPrompt" style='<s:property value="%{showConfirmGenerateFile}"/>' >
		<span id="titlePop" style="color:white;font-size: 16px;vertical-align: middle;">Generate Invoice</span>
		 ...
		 <div style="width:100%;height:130px;background-color:rgb(249,249,249); color:#000000; font-size:14px; padding-left: 0px; padding-right:0px;">
			 		...
			 		<table  cellspacing="0" width="100%" height="130px" border="0">
			 			...
			 			<tr height="45px" valign="top">
				 			...
				 			<input id="btGenerateInvoiceCFM"  type="submit" value="Yes"
