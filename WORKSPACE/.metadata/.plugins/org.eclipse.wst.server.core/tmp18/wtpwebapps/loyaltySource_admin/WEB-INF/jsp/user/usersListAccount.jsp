	...
	<div id="formContainer" style="padding-bottom: 30px;">
		...
		<table>
			...
			<tr>
				...
				<td><s:select id="slectUserStatus" label=""
						cssStyle="width:143px;" headerKey="-1" headerValue="All Users"
						list="#{'1':'Active', '2':'Inactive'}" name="userStatus" />
					Result:<s:property value="%{dataLinks.size}" />
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td>Search:</td>
				<td><input id="search" style="width: : 150px;" name="search" />
				</td>
			</tr>
			<tr>
						...
						<s:iterator value="dataLinks" status="userAccount">
							<s:if test="%{index==0}">
								<tr id="rowUser" class="row_with_color">
									<td id="columnLogin"><s:property value="login" />
									</td>
									...
									<td><s:property value="clientCategoryName" />
									</td>
									<td><a
										href='manageAccountInit.do?userId=<s:property value="id"/>&userName=<s:property value="login"/>'>Manage
									</a> - <a href='editUser.do?userId=<s:property value="id"/>'>
											Edit </a></td>
		...
		<s:form action="usersListAccount.do" method="post" validate="true"
			enctype="multipart/form-data">
			<input type="hidden" id="userStatusCopy" name="userStatus" />
			<input id="showUserlistAccount" type="submit"
				value="showUserlistAccount"
