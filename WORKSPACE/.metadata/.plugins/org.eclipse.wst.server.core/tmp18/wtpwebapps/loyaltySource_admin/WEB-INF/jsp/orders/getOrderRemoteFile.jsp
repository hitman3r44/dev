  ...
  <tr>
	  ...
	  <table border="0" width="100%" style="border-left: 1px solid #CCCCCC; border-right: 1px solid #CCCCCC;
  		 border-bottom: 1px solid #CCCCCC;border-top: 1px solid #CCCCCC; vertical-align:top;">
					...
					<table id="tabUserFiles" style="direction: ltr;table-layout: fixed;" border="0" width="447px">
						...
						<s:iterator value="%{userFilelist}">
	          			<tr id="rowFile" height="25px" style="cursor: pointer;">
							...
							<td style="border:1px solid #CCCCCC;padding-right: 10px;" align="right">
							<s:if test="treated">
				...
				<td align="center" colspan="4"><input type="button" id="btUpload" value="Upload" style="margin:20px 5px 0px 0px;padding:2px 10px;font-size:14px;"/></td>
				</tr>
				<!-- ................................................... -->
	  ...
	  <s:if test="%{userLogo==null}" >
	   <img alt="" width="200px" src='<s:property value="%{userLogo}"/>'/>
	  </s:if>
	  <s:else>
	  	  <img alt="" width="95%" height="95%" src='<s:property value="%{userLogo}"/>'/>
	  </s:else>
	  </td>
  </tr>
  </table>
	...
	<td  style='<s:property value="#order.cssStyle"/>border-bottom: 0px solid #CCCCCC;'>
	 ...
	 <tr height="30px" valign="middle" align="center">
	 	...
	 	<s:if test="%{saved==0}" >
		 	...
		 	<input id="btPrintAllOrders" type="button" value="Print All Orders" style="margin:0px 0px 0px 0px;padding:4px 30px;font-size:16px;"/>
	 	</s:if>
		 	
	 	<s:else>
	 		<input id="btSaveOrders" type="button" value="Save Orders" style="margin:0px 0px 0px 0px;padding:4px 30px;font-size:16px;"/>
		 	<input type="button" value="Print" disabled="disabled" style="margin:0px 0px 0px 0px;padding:4px 30px;font-size:16px;"/>
		 	<input type="button" value="Print All Orders" disabled="disabled" style="margin:0px 0px 0px 0px;padding:4px 30px;font-size:16px;"/>
