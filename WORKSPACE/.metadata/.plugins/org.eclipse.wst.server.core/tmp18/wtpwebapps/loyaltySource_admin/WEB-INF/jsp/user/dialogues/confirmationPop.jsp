...
<div id="confirmationPop" class="conteneurPrompt" >
		<span id="titlePop" style="color:white;font-size: 16px;vertical-align: middle;">Confirmation</span>
			 			...
			 			<tr>
				 			<td colspan="2" align="center" style="padding-left: 20px;padding-right: 20px;">
				 				<div style="max-height: 70px;overflow:auto;font-family: Arial, Helvetica, sans-serif;font-size: 14px;">
				 					<center id="msgConfirmation"><s:property value="%{msgConfirmation}"/></center>
								</div>
				 			</td>
			 			</tr>

			 			<tr height="45px" valign="top">
				 			<td colspan="2" align="center"><input id="btContinue" type="submit" value="Continue"
				 				 style="margin:7px 5px 0px 0px;padding:2px 10px;font-family: Arial, Helvetica, sans-serif;font-size: 14px;" />
