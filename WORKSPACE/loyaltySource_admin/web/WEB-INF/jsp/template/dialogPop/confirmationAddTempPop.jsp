...
<div id="confirmationAddTempPop" class="conteneurPrompt" >
						...
						<!-- ....................................... Text Area des message envoyés ................................... -->
			 			...
			 			<tr>
				 			<td colspan="2" align="center" style="padding-left: 20px;padding-right: 20px;font-family: Arial, Helvetica, sans-serif;font-size: 13px;">
				 				<s:property value="%{msgAddConfirmation}"/>
				 			</td>
			 			</tr>
			 			<tr height="15px">
				 			<td colspan="2" align="center" />
			 			...
			 			<tr height="15px">
				 			<td align="right" width="50%"><input id="btYesAddTemp" type="submit" value="Yes" style="font-family: Arial, Helvetica, sans-serif;font-size: 13px;"/></td>
				 			<td align="left"><input id="btNoAddTemp" type="button" value="No" style="font-family: Arial, Helvetica, sans-serif;font-size: 13px;"/></td>
			 			</tr>
