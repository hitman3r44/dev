...
<div id="divRoot" class="unit" style="width: 1500px; margin-left: 60px;">
	...
	<div id="formContainer" style="padding-bottom: 60px;">
		...
		<s:form id="form" action="reportOrders.do" method="post"
			...
			<s:hidden id="selectAllOrdersSignal" name="selectAllOrdersSignal"
				value="0" />
			...
			<s:hidden id="saveTemporaryRowSignal" name="saveTemporaryRowSignal"
				value="0" />
			<s:hidden id="cancelSignal" name="cancelSignal" value="0" />
			<s:hidden id="addSimilarRowSignal" name="addSimilarRowSignal"
				value="0" />
			<s:hidden id="deleteRowSignal" name="deleteRowSignal" value="0" />
			<s:hidden id="quantityToChangeSignal" name="quantityToChangeSignal"
				value="0" />
			<s:hidden id="duplicateOrderSignal" name="duplicateOrderSignal"
				value="0" />
			<s:hidden id="checkProductPriceSignal" name="checkProductPriceSignal"
				value="0" />
			<s:hidden id="sortingOrdersSignal" name="sortingOrdersSignal"
				value="0" />
			...
			<s:hidden id="okSaveSuccessPopSignal" name="okSaveSuccessPopSignal"
				value="0" />
			...
			<s:hidden id="nextListPagesSignal" name="nextListPagesSignal"
				value="0" />
			<s:hidden id="prevListPagesSignal" name="prevListPagesSignal"
				value="0" />
			...
			<!-- Find Options -->
			<s:hidden id="findOrdersSignal" name="findOrdersSignal" value="0" /> <!-- For search Icon ID -->
			...
			<!-- New Added search field -->
			<s:hidden id="frmProductOrderNumber" name="productOrderNumberSearch" value="" />
			<s:hidden id="frmTrakingNumber" name="trakingNumber" value="" />
			<s:hidden id="frmClientOrderNumber" name="clientOrderNumber" value="" />
			<s:hidden id="frmClientOther" name="clientOther" value="" />
			...
			<s:hidden id="productDescriptionFRM" name="productDescription"
				value="" />
		...
		<s:form id="formToPrint" action="printOrdersToPDF.do" method="post"
			enctype="multipart/form-data">
			<s:hidden id="strPrintInPDFForm" name="strPrint" value="null" />
			<s:hidden id="tansformReportSignal" name="tansformReportSignal"
				value="0" />
			<s:hidden id="allOrdersSelectedSignal" name="allOrdersSelectedSignal"
				value="0" />
			<s:hidden id="printAllOrderPagesSignal"
				name="printAllOrderPagesSignal" value="0" />
		</s:form>

		<!-- FORM FOR DOWNLOAD Admin.xls -->
		<s:form id="formOrdersAdminXLS" action="ordersAdminXLS.do"
			...
			<s:hidden id="allOrdersSelectedSignal" name="allOrdersSelectedSignal"
				value="0" />
			<s:hidden id="reportOrderPageSignal" name="reportOrderPageSignal"
				value="0" />
			<s:hidden id="selectedOrdersListSignal"
				name="selectedOrdersListSignal" value="0" />
			<s:hidden id="generateESTFileSignal" name="generateESTFileSignal"
				value="0" />
		</s:form>
		...
		<table id="tabLogin" width="100%">
			...
			<!-- ....................Search Options.................... -->
			<tr 
			height="60px" style="border-left: 
			1px solid #CCCCCC; border-right: 
			1px solid #CCCCCC; 
...
<%-- 				<td style="padding-left: 5px; width: 80px;" >
				<span id="toggleBetweenLoginAndPONumber" style="font-size: 12px; cursor: pointer; color: rgb(44, 140, 171); text-decoration: underline;">
						Client </span> Login: 
				</td> 
				--%>
...
<%-- 				<td style="padding-left: 5px; width: 80px;">Client Login:</td>
				...
				<s:else>
					<td style="padding-left: 5px; width: 92px;"><span
						id="toggleBetweenlsOrderIdAndclientOrderId"
				...
				<s:if test="%{switchBetweenStatusAndClientOther==null || switchBetweenStatusAndClientOther==0}">
					...
					<td style="padding-left: 5px; width: 100px;"><s:select label=""
							...
							value="%{selectedStatus}" required="false" cssStyle="width: 150px" />
					</td>
				</s:if>
				<s:else>
					<td style="padding-left: 5px; width: 92px;">
					<span id="toggleBetweenStatusAndclientOtherId" style="cursor: pointer; color: rgb(44, 140, 171); text-decoration: underline;">
...
<%-- 				<td style="padding-left: 5px; width: 45px;">Status:</td>
				...
				<td style="padding-left: 5px; width: 140px;" valign="middle">
					<s:if
						test="%{reportDateBetween==null || reportDateBetween==0}">
						<span id="factorDateBetweenId"
							style="cursor: pointer; color: rgb(44, 140, 171); text-decoration: underline;">PO
							Date </span> between:
					</s:if> 
					<s:else>
						<span id="factorDateBetweenId"
							style="cursor: pointer; color: rgb(44, 140, 171); text-decoration: underline;">Shipped
							Date </span> between:
					</s:else>
				</td>
				
				<td style="padding-left: 5px; width:172px;">
				<s:date id="creationDateStart" name="creationDateStart" var="creationDateStart" format="dd/MM/yyyy" /> 
				<s:textfield id="creationDateStartPicker"
						name="strCreationDateStart" value="%{#creationDateStart}"
						key="labelkey" readonly="false" cssStyle="width:150px;" />
				</td>
				<!-- ...Creation Date End... -->
				
				<td style="padding-left: 5px;"><s:date id="creationDateEnd"
						name="creationDateEnd" var="creationDateEnd" format="dd/MM/yyyy" />
					<s:textfield id="creationDateEndPicker" name="strCreationDateEnd"
						value="%{#creationDateEnd}" key="labelkey" readonly="false"
						cssStyle="width:150px;" />
				</td>


				<td style="padding-left: 5px;"><img id="iconFindOrders"
					src="images/orders/findOrders.png" />
				</td>
			</tr>

<%-- 			<tr height="60px" style="border-left: 1px solid #CCCCCC; 
				border-right: 1px solid #CCCCCC; 
				border-bottom: 1px solid #CCCCCC;
				vertical-align: middle;">
				
				<!-- ...PO Number... -->
				<td style="padding-left: 5px; width: 45px;">PO Number:</td>
				<td style="padding-left: 5px;">
				<s:textfield id="poNumberId" name="productOrderNumberSearch" value="%{productOrderNumber}" cssStyle="width:150px" />
				</td>

				<!-- ...Tracking Number... -->
				<td style="padding-left: 5px; width: 45px;">Tracking Number:</td>
				<td style="padding-left: 5px;">
				<s:textfield id="trakingNumberId" name="trakingNumber" value="%{trackingNumber}" cssStyle="width:100px" />
				</td>

				<!-- ...Client Order Id... -->
				<td style="padding-left: 5px; width: 45px;">Client Order Id:</td>
				<td style="padding-left: 5px;">
				<s:textfield id="clientOrderId"	name="clientOrderNumber" value="%{clientOrderNumber}" cssStyle="width:100px" />
				</td>

				<!-- ...Client Other Id... -->
				<td style="padding-left: 5px; width: 45px;">Client Other Id:</td>
				<td style="padding-left: 5px;">
				<s:textfield id="clientOtherId"	name="clientOther" value="%{clientOtherId}" cssStyle="width:150px" />
				</td>
 ...
 --%>
		...
		<table id="tabPrintAndXLS">
			<tr height="50px" valign="middle">
				<td id="listOrderDTOSize" width="110px">Result/page:<s:property
						value="%{listOrdersDTO.size}" />
				</td>
				<td width="105px">Total:<s:property value="%{totalOrders}" />
				</td>
				<s:if test="%{listOrdersDTO.size > 0  && superAdmin!=null}">
					<td width="80px"><img id="imgGetAdminXLSEST"
						src="images/orders/xlsEst.png" style="cursor: pointer;" />
					</td>

					<td width="80px"><img id="imgGetAdminXLS"
						src="images/orders/xls.png" style="cursor: pointer;" />
					</td>
				...
				<s:if
					test='%{listOrdersDTO.size > 0 && usersPrivShippedToInvoiced!=null}'>
		...
		<s:hidden id="sizeResult" name="sizeResult"
			value="%{listOrdersDTO.size}" />

		<!-- ............................. Orders List ............................... -->
		<br />
		<table id="tabOrderOrders" width="5030px" border="0"
			class="nowraptable datatable"
			...
			<thead class="gray_header">
				<tr height="30px">
					...
					<td width="130px"
						style="padding-left: 10px; border-right: 1px solid white;">LS
						Product ID<img id="imgSort" src="images/orders/sortColumn.png"
						align="right"
						style="vertical-align: middle; cursor: pointer; padding-right: 10px;" />
					</td>
					<td width="90px"
					...
					<td width="120px"
						style="padding-left: 10px; border-right: 1px solid white;">PO
						number<img id="imgSort" src=""
						style="visibility: hidden; display: none; padding-right: 10px;" />
					</td>
					<td width="160px"
						style="padding-left: 10px; border-right: 1px solid white;">Client
						Product number<img id="imgSort" src=""
						style="visibility: hidden; display: none; padding-right: 10px;" />
					</td>
					<td width="110px"
						style="padding-left: 10px; border-right: 1px solid white;">Client
					...
					<td width="165px"
						style="padding-left: 10px; border-right: 1px solid white;">Client
						Other ID<img id="imgSort" src=""
						style="visibility: hidden; display: none; padding-right: 10px;" />
					</td>

					<td width="150px"
						style="padding-left: 10px; border-right: 1px solid white;">Client
						First Name<img id="imgSort" src=""
						style="visibility: hidden; display: none; padding-right: 10px;" />
					</td>
					<td width="150px"
						style="padding-left: 10px; border-right: 1px solid white;">Client
						Last Name<img id="imgSort" src=""
						style="visibility: hidden; display: none; padding-right: 10px;" />
					</td>
					<td width="130px"
						style="padding-left: 10px; border-right: 1px solid white;">Client
						Other Names<img id="imgSort" src=""
						style="visibility: hidden; display: none; padding-right: 10px;" />
					</td>
					<td width="100px"
						style="padding-left: 10px; border-right: 1px solid white;">Client
					...
					<td width="170px"
						style="padding-left: 10px; border-right: 1px solid white;">Client
						Street<img id="imgSort" src=""
						style="visibility: hidden; display: none; padding-right: 10px;" />
					</td>
					<td width="170px"
						style="padding-left: 10px; border-right: 1px solid white;">Client
						Other Address<img id="imgSort" src=""
						style="visibility: hidden; display: none; padding-right: 10px;" />
					</td>
					<td width="100px"
						style="padding-left: 10px; border-right: 1px solid white;">Client
						City<img id="imgSort" src=""
						style="visibility: hidden; display: none; padding-right: 10px;" />
					</td>
					<td width="110px"
						style="padding-left: 10px; border-right: 1px solid white;">Client
						Province<img id="imgSort" src=""
						style="visibility: hidden; display: none; padding-right: 10px;" />
					</td>
					<td width="130px"
						style="padding-left: 10px; border-right: 1px solid white;">Client
						Postal Code<img id="imgSort" src=""
						style="visibility: hidden; display: none; padding-right: 10px;" />
					</td>
					<td width="100px"
						style="padding-left: 10px; border-right: 1px solid white;">Client
						Phone<img id="imgSort" src=""
						style="visibility: hidden; display: none; padding-right: 10px;" />
					</td>
					<td width="180px"
						style="padding-left: 10px; border-right: 1px solid white;">Client
						Email<img id="imgSort" src=""
						style="visibility: hidden; display: none; padding-right: 10px;" />
					</td>
					<td width="170px"
						style="padding-left: 10px; border-right: 1px solid white;">Shipping
						Company<img id="imgSort" src="images/orders/sortColumn.png"
						align="right"
						style="vertical-align: middle; cursor: pointer; padding-right: 10px;" />
					</td>
					<td width="135px"
						style="padding-left: 10px; border-right: 1px solid white;">Shipped
						Date<img id="imgSort" src="images/orders/sortColumn.png"
						align="right"
						style="vertical-align: middle; cursor: pointer; padding-right: 10px;" />
					</td>
					<td width="170px"
						style="padding-left: 10px; border-right: 1px solid white;">Tracking
						Number<img id="imgSort" src="images/orders/sortColumn.png"
						align="right"
						style="vertical-align: middle; cursor: pointer; padding-right: 10px;" />
					</td>
					<td width="110px"
						style="padding-left: 10px; border-right: 1px solid white;">Shipping
						Price<img id="imgSort" src=""
						style="visibility: hidden; display: none; padding-right: 10px;" />
					</td>
					<td width="95px"
						style="padding-left: 10px; border-right: 1px solid white;">Billed</td>
										...
										<tr height="45px" id="rowOrder"
											...
											<s:if test="superAdmin!=null">
												<td id="columnRowOrderId" width="220px"
													style="border-right: 1px solid #CCCCCC; padding-left: 5px; padding-right: 5px; padding-top: 5px; padding-bottom: 5px; font-weight: bold; color: rgb(44, 140, 171); overflow: hidden; text-overflow: ellipsis; cursor: pointer;"><s:property
														value="#order.lsOrderId" /><img id="editRowOrder"
													src="images/orders/editRowOrder.png" align="right"
													style="vertical-align: middle; padding-right: 0px;" /></td>
											</s:if>
											<s:else>
												<td width="220px"
													style="border-right: 1px solid #CCCCCC; padding-left: 5px; padding-right: 5px; padding-top: 5px; padding-bottom: 5px; font-weight: bold; overflow: hidden; text-overflow: ellipsis;"><s:property
														value="#order.lsOrderId" /></td>
											</s:else>
											...
											<td width="120px"
												...
												<s:if test='showRowShipping==0 && superAdmin!=null'>
													...
													<s:select id="statusId" name="statusId" list="listStatus"
														...
														listValue="status" headerValue="--Select--"
											...
											<td width="120px"
												style="border-right: 1px solid #CCCCCC; padding-left: 5px; padding-right: 5px; padding-top: 5px; padding-bottom: 5px; overflow: hidden; text-overflow: ellipsis;"><s:property
													value="#order.unitPrice" /></td>
											<td width="120px"
												style="border-right: 1px solid #CCCCCC; padding-left: 5px; padding-right: 5px; padding-top: 5px; padding-bottom: 5px; overflow: hidden; text-overflow: ellipsis;"><s:property
													value="#order.lsPrice" /></td>
											<td width="132px"
												style="border-right: 1px solid #CCCCCC; padding-left: 5px; padding-right: 5px; padding-top: 5px; padding-bottom: 5px; overflow: hidden; text-overflow: ellipsis;">
												<s:if test='%{#order.currencyId != 1}'>
													<span style="color: #0000FF;"> <s:property
															value="#order.currencyUnitPrice" /> <s:property
															value="#order.currencySymbol" /> </span>
												</s:if>
											</td>
											<td width="120px"
												style="border-right: 1px solid #CCCCCC; padding-left: 5px; padding-right: 5px; padding-top: 5px; padding-bottom: 5px; overflow: hidden; text-overflow: ellipsis;">
												<s:if test='%{#order.currencyId != 1}'>
													<span style="color: #0000FF;"> <s:property
															value="#order.currencyPrice" /> <s:property
															value="#order.currencySymbol" /> </span>
												</s:if>
											</td>
											<td width="170px"
												...
												</s:if> <s:elseif test="showOnlyEditNote==1 && superAdmin!=null">
													<s:textfield id="notes" name="notes" value="%{notes}"
														cssStyle="width:115px" />
													<a id="saveNotes" href="#" style="align: rigth;"> Save</a>
													<center id="editNotes"></center>
												</s:elseif> <s:else>
													<s:property value="#order.notes" />
												</s:else>
											</td>
											<td width="120px"
												style="border-right: 1px solid #CCCCCC; padding-left: 5px; padding-right: 5px; padding-top: 5px; padding-bottom: 5px; overflow: hidden; text-overflow: ellipsis;"><s:property
													value="#order.productOrderNumber" /></td>
											<td width="160px"
												style="border-right: 1px solid #CCCCCC; padding-left: 5px; padding-right: 5px; padding-top: 5px; padding-bottom: 5px; overflow: hidden; text-overflow: ellipsis;"><s:property
													value="#order.clientProductNumber" /></td>
											<td width="110px"
												style="border-right: 1px solid #CCCCCC; padding-left: 5px; padding-right: 5px; padding-top: 5px; padding-bottom: 5px; overflow: hidden; text-overflow: ellipsis;"><s:property
													value="#order.clientOrderNumber" /></td>

											<td width="165px"
												style="border-right: 1px solid #CCCCCC; padding-left: 5px; padding-right: 5px; padding-top: 5px; padding-bottom: 5px; overflow: hidden; text-overflow: ellipsis;"><s:property
													value="#order.clientOtherId" /></td>

											<td width="150px"
												style="border-right: 1px solid #CCCCCC; padding-left: 5px; padding-right: 5px; padding-top: 5px; padding-bottom: 5px; overflow: hidden; text-overflow: ellipsis;"><s:property
													value="#order.clientFirstName" /></td>
											<td width="150px"
												style="border-right: 1px solid #CCCCCC; padding-left: 5px; padding-right: 5px; padding-top: 5px; padding-bottom: 5px; overflow: hidden; text-overflow: ellipsis;"><s:property
													value="#order.clientLastName" /></td>
											<td width="130px"
												style="border-right: 1px solid #CCCCCC; padding-left: 5px; padding-right: 5px; padding-top: 5px; padding-bottom: 5px; overflow: hidden; text-overflow: ellipsis;"><s:property
													value="#order.clientOtherNames" /></td>
											<td width="100px"
												style="border-right: 1px solid #CCCCCC; padding-left: 5px; padding-right: 5px; padding-top: 5px; padding-bottom: 5px; overflow: hidden; text-overflow: ellipsis;"><s:property
													value="#order.clientNumber" /></td>
											<td width="170px"
												style="border-right: 1px solid #CCCCCC; padding-left: 5px; padding-right: 5px; padding-top: 5px; padding-bottom: 5px; overflow: hidden; text-overflow: ellipsis;"><s:property
													value="#order.clientStreet" /></td>
											<td width="170px"
												style="border-right: 1px solid #CCCCCC; padding-left: 5px; padding-right: 5px; padding-top: 5px; padding-bottom: 5px; overflow: hidden; text-overflow: ellipsis;"><s:property
													value="#order.clientOtherStreet" /></td>
											<td width="100px"
												style="border-right: 1px solid #CCCCCC; padding-left: 5px; padding-right: 5px; padding-top: 5px; padding-bottom: 5px; overflow: hidden; text-overflow: ellipsis;"><s:property
													value="#order.clientCity" /></td>
											<td id="clientProvince" width="110px"
												style="border-right: 1px solid #CCCCCC; padding-left: 5px; padding-right: 5px; padding-top: 5px; padding-bottom: 5px; overflow: hidden; text-overflow: ellipsis;"><s:property
													value="#order.clientProvince" /></td>
											<td width="130px"
												style="border-right: 1px solid #CCCCCC; padding-left: 5px; padding-right: 5px; padding-top: 5px; padding-bottom: 5px; overflow: hidden; text-overflow: ellipsis;"><s:property
													value="#order.clientPostalCode" /></td>
											<td width="100px"
												style="border-right: 1px solid #CCCCCC; padding-left: 5px; padding-right: 5px; padding-top: 5px; padding-bottom: 5px; overflow: hidden; text-overflow: ellipsis;"><s:property
													value="#order.clientPhone" /></td>
											<td width="180px"
												style="border-right: 1px solid #CCCCCC; padding-left: 5px; padding-right: 5px; padding-top: 5px; padding-bottom: 5px; overflow: hidden; text-overflow: ellipsis;"><s:property
													value="#order.clientEmail" /></td>
											<td width="170px"
												style="border-right: 1px solid #CCCCCC; padding-left: 5px; padding-right: 5px; padding-top: 5px; padding-bottom: 5px; overflow: hidden; text-overflow: ellipsis;">
												<s:if test="showRowShipping==0  && superAdmin!=null">
													<s:property value="#order.shippingCompany" />
													<a id="editShippingCompany" href="#" style="align: rigth;">
														Edit</a>
													<center id="saveShippingCompany"></center>
													<center id="shippingCompany"></center>
												</s:if> <s:elseif test="showRowShipping!=0  && superAdmin!=null">
													<s:textfield id="shippingCompany" name="shippingCompany"
														value="%{shippingCompany}" cssStyle="width:110px" />
													<a id="saveShippingCompany" href="#" style="align: rigth;">
														Save</a>
													<center id="editShippingCompany"></center>
												</s:elseif> <s:else>
													<s:property value="#order.shippingCompany" />
												</s:else>
											</td>
											<td width="135px"
												...
												<s:if test="showRowShipping==0 && superAdmin!=null">
													...
													<a id="editShippedDate" href="#" style="align: rigth;">
														Edit</a>
													<center id="saveShippedDate"></center>

												</s:if> <s:elseif test="showRowShipping!=0 && superAdmin!=null">
													<input type="text" id="saveShippedDatePicker"
														name="strShippedDate"
														value='<s:property value="#order.shippedDate" />'
														style="width: 80px;" />
													<a id="saveShippedDate" href="#" style="align: rigth;">
														Save</a>
													<center id="editShippedDate"></center>
												</s:elseif> <s:else>
													<s:property value="#order.shippedDate" />
												</s:else>
											</td>
											<td width="170px"
												...
												<s:if test="showRowShipping==0  && superAdmin!=null">
													...
													<a id="editTrackingNumber" href="#" style="align: rigth;">
														Edit</a>
													<center id="saveTrackingNumber"></center>
													<center id="trackingNumber"></center>
												</s:if> <s:elseif test="showRowShipping!=0  && superAdmin!=null">
													<s:textfield id="trackingNumber" name="trackingNumber"
														value="%{trackingNumber}" cssStyle="width:115px;" />
													<a id="saveTrackingNumber" href="#" style="align: rigth;">
														Save</a>
													<center id="editTrackingNumber"></center>
												</s:elseif> <s:else>
													<s:property value="#order.trackingNumber" />
												</s:else>
											</td>
											<td width="110px"
												...
												<s:if test="showRowShipping==0  && superAdmin!=null">
													...
													<a id="editShippingPrice" href="#" style="align: rigth;">
														Edit</a>
													<center id="saveShippingPrice"></center>
													<center id="shippingPriceToEdit"></center>
												</s:if> <s:elseif test="showRowShipping!=0  && superAdmin!=null">
													<s:textfield id="shippingPriceToEdit"
														name="strShippingPrice" value="%{shippingPrice}"
														cssStyle="width:60px;" />
													<a id="saveShippingPrice" href="#" style="align: rigth;">
														Save</a>
													<center id="editShippingPrice"></center>
												</s:elseif> <s:else>
													<s:property value="#order.shippingPrice" />
												</s:else>
											</td>
		...
		<table align="center" id="tabPageIndex">
			...
			<tr>
				<td><s:if
						test="indexSet>10*PAGE_ITEMS_COUNT && listOrdersDTO.size>0">
						<!-- pagesNumber*resultRangeInDB -->
						<img id="imgPrevListPages"
							src="images/orders/activePreviousPages.png" />
					</s:if> <s:elseif test="listOrdersDTO.size>0">
						<img src="images/orders/desablePreviousPages.png" />
					</s:elseif>
				</td>
				<s:iterator value="listIndexSet" id="item">
					<s:if test="listOrdersDTO.size>0">
						<td id="pageIndex" align="center"
							style='font-size: 14px; width: 50px;cursor:pointer;font-weight: bold;color: rgb(44,140,171);<s:property value="#item.cssStyle"/>'>
							<s:hidden id="pageIndexHedden" name="pageIndexHedden"
								value="%{#item.index}" /> <s:property value="#item.index" />
						</td>
					</s:if>
				</s:iterator>
				<td><s:if
						test="((nextListPages+10)*PAGE_ITEMS_COUNT>totalOrders)&& listOrdersDTO.size>0">
						<!-- (nextListPages+pagesNumber)*resultRangeInDB -->
		...
		<script type="text/javascript" charset="utf-8">
					...
					.ready(
							function() {
								...
								function createStrPrint() {
									var index = 0;
									$(
											'#tabOrderOrders input[id="checkBoxItem"]')
											.each(
													function() {
														arrayPrint[index] = $(
																this).attr(
								...
								/*------------------------------------- ToolTip ------------------------------------------ 
								  ...
								  ----------------------------------------------------------------------------------------*/
								$(
										'#orderDetailPop #iconDeleteRow,#iconSimilarRow,#iconSaveTemporaryRow,#quantityToChange')
										.mouseover(
												function() {
													var indexDelete = $(
															'#orderDetailPop   #iconDeleteRow')
															.index(this);
													var indexSimilar = $(
															'#orderDetailPop  #iconSimilarRow')
															.index(this);
													var indexValidate = $(
															'#orderDetailPop #iconSaveTemporaryRow')
															.index(this);
													var indexQuantitySplit = $(
															'#orderDetailPop #quantityToChange')
															.index(this);
													var position;
													var showPop = 0;
													if (indexDelete >= 0) {
													...
													if (indexValidate >= 0) {
														...
														$(
																'#orderDetailPop #message')
																.text(
																		"Validate Modification before Saving");
														showPop = 1;
													}
													if (indexQuantitySplit >= 0) {
														...
														$(
																'#orderDetailPop #message')
																.text(
																		"Enter a valid amount for Duplication");
														showPop = 1;
													}
													var y = position.top;
													var height = $(
															'#orderDetailPop #toolTipPop')
															.height();
													y = (y - height);
													var x = position.left;
													var toolTipWidth = $(
								...
								/*------------------------------------- ToolTipReport ------------------------------------ 
								  ...
								  ----------------------------------------------------------------------------------------*/
								$(
										'#tabPrintAndXLS #imgGetAdminXLSEST,#imgGetAdminXLS,#imgPrintOrders,#imgPrintAllOrders,#imgGetInvoicedXLS')
										.mouseover(
												function() {
													var indexAdminXLSEST = $(
															'#tabPrintAndXLS   #imgGetAdminXLSEST')
															.index(this);
													var indexAdminXLS = $(
															'#tabPrintAndXLS  #imgGetAdminXLS')
															.index(this);
													var indexPrintOrders = $(
															'#tabPrintAndXLS #imgPrintOrders')
															.index(this);
													var indexPrintAllOrders = $(
															'#tabPrintAndXLS #imgPrintAllOrders')
															.index(this);
													var indexInvoicedXLS = $(
															'#tabPrintAndXLS #imgGetInvoicedXLS')
															.index(this);
													var position;
													var showPop = 0;
													if (indexAdminXLSEST >= 0) {
														position = $(
																...
																.position();
														$(
																'#toolTipReportPop #message')
																.text(
																		"Select first Orders to get Canada Post CSV File");
														showPop = 1;
													}
													if (indexAdminXLS >= 0) {
														position = $(
													...
													if (indexInvoicedXLS >= 0) {
														...
														$(
																'#toolTipReportPop #message')
																.text(
																		"Select first Orders and Partner Name to get Invoiced Orders List");
														showPop = 1;
													}
													var y = position.top;
													var height = $(
								...
								/*------------------------------------- ToolTipReport:icone Print -------------------------------- 
								  ...
								  ------------------------------------------------------------------------------------------------*/
								$('#tabOrderOrders #imgSort,#imgSelectAllPO')
										.mouseover(
												function() {
													var index = $(
															'#tabOrderOrders #imgSort')
															.index(this);
													var position;
													var showPop = 0;
													if (index == 0) {
								...
								$(
										'#orderDetailPop #confirmDeleteOrderPop #btDeleteOrderCFM')
										.click(
												function() {
													recoveryDataOrder();
													//keep position of detail popup 
								...
								$(
										'#orderDetailPop #confirmDeleteOrderPop #btCancelCFM')
										.click(
												function() {
													recoveryDataOrder();
													//keep position of detail popup 
								...
								$(
										'#tabOrderOrders #editShippingCompany,#editTrackingNumber,#editShippedDate,#editShippingPrice,#statusToEdit')
										.click(
												function() {
													var index = $(
															'#tabOrderOrders #statusToEdit')
															.index(this);
													if (index < 0)
														index = $(
																'#tabOrderOrders #editShippingCompany')
																.index(this);
													if (index < 0)
														index = $(
																'#tabOrderOrders #editTrackingNumber')
																.index(this);
													if (index < 0)
														index = $(
																'#tabOrderOrders #editShippedDate')
																.index(this);
													if (index < 0)
														index = $(
																'#tabOrderOrders #editShippingPrice')
																.index(this);
													var indexOrderToEdit = $(
															"#tabOrderOrders #columnIndexOrder")
															.eq(index).text();
													var userLogin = $(
															"#txtUserLoginTo")
															.val();
								...
								//when Admin click on any button "Save"
								$(
										'#tabOrderOrders #saveShippingCompany,#saveTrackingNumber,#saveShippedDate,#saveShippingPrice,#saveStatus')
										.click(
												function() {
													var index = $(
															'#tabOrderOrders #saveShippingPrice')
															.index(this);
													var statusId = -1;
													if (index < 0)
														index = $(
																'#tabOrderOrders #saveShippingCompany')
																.index(this);
													if (index < 0)
														index = $(
																'#tabOrderOrders #saveTrackingNumber')
																.index(this);
													if (index < 0)
														index = $(
																'#tabOrderOrders #saveShippedDate')
																.index(this);
													if (index < 0) {
														index = $(
																'#tabOrderOrders #saveStatus')
																.index(this);
														statusId = $(
																'#tabOrderOrders #statusId')
																.eq(index)
																.val();
													}
													var userLogin = $(
													...
													var notes = $(
															...
															.eq(index).val();
													var shippingCompany = $(
															"#tabOrderOrders #shippingCompany")
															.eq(index).val();
													var trackingNumber = $(
															"#tabOrderOrders #trackingNumber")
															.eq(index).val();
													var code = $(
															'#tabOrderOrders #clientProvince')
															.eq(index).text();
													var shppedDate = $(
															'#tabOrderOrders #saveShippedDatePicker')
															.eq(0).val();
													var strShippingPrice = $(
															'#tabOrderOrders #shippingPriceToEdit')
															.eq(index).val();
												...
												$("#strShippingPriceFRM").val(
														strShippingPrice);
												$("#strShippedDateFRM").val(
														shppedDate);
												$('#codeFRM').val(code);
												$("#notesFRM").val(notes);
												$("#shippingCompanyFRM").val(
														shippingCompany);
												$("#trackingNumberFRM").val(
														trackingNumber);
												$("#indexOrder").val(
														indexOrderToEdit);
												scrollTop = $(window)
								...
								/*--------------------------- Select Order From Table in ReportOrder -------------------------
								  ...
								  --------------------------------------------------------------------------------------------*/
								$('#tabOrderOrders #columnRowOrderId')
										.click(
												function() {
													var index = $(
															'#tabOrderOrders #columnRowOrderId')
										...
										.blur(
												function() {
													...
													var indexOrder = $(
															...
															.eq(index).text();
													var indexRow = $(
															"#orderDetailPop #indexRow")
															.eq(index).text();
													var userId = $(
															"#orderDetailPop #userId")
															.eq(index).text();
													var lsProductID = $(
															"#orderDetailPop #lsProductID")
															.eq(index).val();
													...
													//recovery data Order 	
													var code = $(
															'#tabOrderDetailPop #provinceId')
															.val();
													$('#codeFRM').val(code);
													var clientLastName = $(
															'#tabOrderDetailPop #clientLastName')
															.val();
													var clientFirstName = $(
															'#tabOrderDetailPop #clientFirstName')
															.val();
													var clientOtherNames = $(
															'#tabOrderDetailPop #clientOtherNames')
															.val();
													var clientStreet = $(
															'#tabOrderDetailPop #clientStreet')
															.val();
													var clientOtherStreet = $(
															'#tabOrderDetailPop #clientOtherStreet')
															.val();
													var clientCity = $(
															'#tabOrderDetailPop #clientCity')
															.val();
													var clientProvince = $(
															'#tabOrderDetailPop #clientProvince')
															.val();
													var clientPostalCode = $(
															'#tabOrderDetailPop #clientPostalCode')
															.val();
													var clientPhone = $(
															'#tabOrderDetailPop #clientPhone')
															.val();
													var clientEmail = $(
															'#tabOrderDetailPop #clientEmail')
															.val();
													var productOrderNumber = $(
															'#tabOrderDetailPop #productOrderNumber')
															.val();
													var creationDate = $(
															'#tabOrderDetailPop #creationDate')
															.val();
													var requiredDate = $(
															'#tabOrderDetailPop #requiredDate')
															.val();
													var creationOrderDate = $(
															'#tabOrderDetailPop #creationOrderDate')
															.val();
													var companyHeader = $(
															'#tabOrderDetailPop #companyHeader')
															.val();
													$('#productOrderNumberFRM')
															.val(
																	productOrderNumber);
													$('#creationDateFRM').val(
															creationDate);
													...
													$('#clientOtherNamesFRM')
															.val(
																	clientOtherNames);
													$('#companyHeaderFRM').val(
															companyHeader);
													$('#clientStreetFRM').val(
															clientStreet);
													$('#clientOtherStreetFRM')
															.val(
																	clientOtherStreet);
													$('#clientCityFRM').val(
															clientCity);
								...
								/*------------------------------- Show icon validate in red color -------------------------------
								  ...
								  -----------------------------------------------------------------------------------------------*/
								$(
										"#orderDetailPop #lsProductID,#quantity,#quantityToChange,#stock,#productDescription,#unitPrice,#shippingFee,#shippingCompany,#trackingNumber")
										.change(
												function() {
													var index = $(
															"#orderDetailPop #lsProductID")
													...
													if (index < 0)
														index = $(
																"#orderDetailPop #quantity")
																.index(this);
													if (index < 0)
														index = $(
																"#orderDetailPop #stock")
																.index(this);
													if (index < 0)
														index = $(
																"#orderDetailPop #productDescription")
																.index(this);
													if (index < 0)
														index = $(
																"#orderDetailPop #shippingFee")
																.index(this);
													if (index < 0)
														index = $(
																"#orderDetailPop #shippingCompany")
																.index(this);
													if (index < 0)
														index = $(
																"#orderDetailPop #trackingNumber")
																.index(this);
													if (index < 0)
														index = $(
																"#orderDetailPop #unitPrice")
																.index(this);
													if (index < 0)
														index = $(
																"#orderDetailPop #quantityToChange")
													...
													if (index >= 0)
														$(
																...
																.eq(index)
																.attr("src",
																		"images/orders/itemNotValidated.png");
												});
										...
										.click(
												function() {
													...
													var trackingNumber = $(
															...
															.eq(index).val();
													var companyHeader = $(
															"#orderDetailPop #companyHeader")
															.eq(index).val();
													$("#quantityFRM").val(
															quantity);
													$("#lsProductIDFRM").val(
															lsProductID);
													$("#productDescriptionFRM")
															.val(
																	productDescription);
													$("#unitPriceFRM").val(
															unitPrice);
								...
								$("#btSave")
										.click(
												function() {
													var indexOrder = $(
															'#tabOrderRowsDetailPop #indexOrder')
															.eq(0).text();
													$('#indexOrder').val(
															indexOrder);
													scrollTop = $(window)
								...
								$('#imgGetAdminXLSEST').mouseover(
										function() {
											$('#imgGetAdminXLSEST').attr(
													"width", "40");
											$('#imgGetAdminXLSEST').attr(
													"higth", "40");
										});
								$('#imgGetAdminXLSEST').mouseout(
										function() {
											$('#imgGetAdminXLSEST').attr(
													"width", "32");
											$('#imgGetAdminXLSEST').attr(
								...
								$('#imgGetInvoicedXLS')
										.click(
												function() {
													$("#reportOrderPageSignal")
															.val("1");
													$(
															"#selectedOrdersListSignal")
															.val("3");
													scrollTop = $(window)
															.scrollTop();
													$("#pageTop")
												...
												function() {
													...
													if (index != 0) {
														...
														var checkValues = $(
																'#tabOrderOrders input[id="checkBoxItem"]')
																.attr('checked');
														var checkDisableValues = $(
																'#tabOrderOrders input[id="checkBoxItem"]')
																.attr(
																		'disabled');
														if (checkDisableValues)
															return false;
														if (checkValues) {
															$(
																	'#tabOrderOrders input[id="checkBoxItem"]')
								...
								/*----------------------------------- Orders Select All ------------------------------------
															when Admin click on the icon imgSort
								  ------------------------------------------------------------------------------------------*/
								$('#tabOrderOrders img[id="imgSelectAllPO"]')
										.click(
												function() {
													var index = $(
															'#tabOrderOrders img[id="imgSelectAllPO"]')
								...
								/*----------------------------- Make divRowsOrder's cursor in default -----------------------
								  ...
								  -------------------------------------------------------------------------------------------*/
								$('#divRowsOrder').mousemove(
										function() {
											$("#divRowsOrder").css('cursor',
													'default');
										});
								...
								$('#imgPrintAllOrders').mouseover(
										function() {
											$('#imgPrintAllOrders').attr(
													"width", "40");
											$('#imgPrintAllOrders').attr(
													"higth", "40");
										});
								$('#imgPrintAllOrders').mouseout(
										function() {
											$('#imgPrintAllOrders').attr(
													"width", "32");
											$('#imgPrintAllOrders').attr(
								...
								//when Admin mouve mouse on printAll image 
								$('#imgGetInvoicedXLS').mouseover(
										function() {
											$('#imgGetInvoicedXLS').attr(
													"width", "40");
											$('#imgGetInvoicedXLS').attr(
													"higth", "40");
										});
								$('#imgGetInvoicedXLS').mouseout(
										function() {
											$('#imgGetInvoicedXLS').attr(
													"width", "32");
											$('#imgGetInvoicedXLS').attr(
			...
			//when Admin click on a imge imgPrevListPages 
								...
								function fillSarchParameters() {
									...
									$("#frmTrakingNumber").val(trakingNumber);
									var clientOrderNumber = $("#clientOrderId").val();
									$("#frmClientOrderNumber").val(clientOrderNumber);
									var clientOther = $("#clientOtherId").val();
									$("#frmClientOther").val(clientOther);
								}
