...
<BR>
        ...
        <tbody>
            ...
            <tr id="rowUser">
            	<td style="display:none;visibility:hidden"><input type="hidden" id="template" value='<s:property value="template"/>'/></td>
...
<TABLE BORDER="0" WIDTH="700px">
	<TR><TD>
		...
		<s:form name="List" action="getProductList.do">
		    <s:hidden id="signalESuccessHid" name="signalESuccessHid" value="" />
		    <s:hidden id="brandIDESuccessHid" name="brandIDESuccessHid" value="" />
		    <s:hidden id="categoryIDESuccessHid" name="categoryIDESuccessHid" value="" />
		    <input id="productListESuccessButton" name="productListESuccessButton" 
...
/* <![CDATA[ */ 
$("#productListESuccessButton").click(function() { 
   var signalESuccess = -300;   // A unique value
   $("#signalESuccessHid").attr('value', signalESuccess);
   var bESuccess = '<s:property value="brand"/>';
   var cESuccess = '<s:property value="category"/>';
   $("#brandIDESuccessHid").attr('value', bESuccess);
   $("#categoryIDESuccessHid").attr('value', cESuccess);
});
/*  ]]> */
</script>