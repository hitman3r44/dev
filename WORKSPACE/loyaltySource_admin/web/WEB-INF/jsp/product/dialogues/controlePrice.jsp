...
<div id="controlePrice" class="conteneurPrompt" >
		<span style="color:white;font-size: 16px;vertical-align: middle;">Warning</span>
			 		...
			 		<table  cellspacing="0" width="100%" height="130px" border="0">
			 			...
			 			<tr>
				 			<td colspan="2" align="center" style="padding-left: 20px;padding-right: 20px;">
				 				...
				 				There is one or more not-excluded products without price.
								Do you want to exclude them [Yes/No]?
								</div>
				 			</td>
			 			</tr>

			 			<tr height="45px" valign="top">
				 			<td align="right" width="50%"><input id="btYesControlePrice" style="font-family: Arial, Helvetica, sans-serif;font-size: 14px;" type="button" value="Yes"/></td>
				 			<td align="left"><input id="btNoControlePrice" type="button" value="No" style="font-family: Arial, Helvetica, sans-serif;font-size: 14px;"/></td>
			 			</tr>
