...
<div id="confirmCPVerifiedPop" class="conteneurPrompt" style="visibility:hidden;display:none;" >
		<span id="titlePop" style="color:white;font-size: 16px;vertical-align: middle;">Product and Box Sizes</span>
