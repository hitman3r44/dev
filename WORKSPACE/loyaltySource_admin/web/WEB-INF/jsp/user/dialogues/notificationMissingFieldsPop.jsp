...
<div id="notificationMissingFieldsPop" class="conteneurPrompt" style='<s:property value="%{showNotificationMissingFieldsPop}"/>' >
		<span id="titlePop" style="color:white;font-size: 16px;vertical-align: middle;">User Connection Details</span>   
			 			...
			 			<tr>
				 			<td colspan="2" align="center" style="padding-left: 20px;padding-right: 20px;">
				 				<div style="max-height: 70px;overflow:auto;font-family: Arial, Helvetica, sans-serif;font-size: 14px;">
				 					<center id="msgConfirmation"><s:property value="%{message}"/></center>
								</div>
				 			</td>
			 			</tr>
