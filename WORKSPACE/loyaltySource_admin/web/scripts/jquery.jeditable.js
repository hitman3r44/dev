                    ...
                    if (false !== onsubmit.apply(form, [settings, self])) { 
                        ...
                        if (false !== submit.apply(form, [settings, self])) { 
                          ...
                          if ($.isFunction(settings.target)) {
                              ...
                              var submitdata = {};
                              submitdata[settings.name] = input.val().replace(/\,/g, '');
                              ...
                              var ajaxoptions = {
                                  ...
                                  success : function(result, status) {
                                      if (ajaxoptions.dataType == 'html') {
                                    	  var resultFormatted = parseFloat(result).toFixed(2);
                                    	  
                                    	  // See function [thousandsSeparator()] at the bottom hereof.
                                    	  $(self).html(thousandsSeparator(resultFormatted));
